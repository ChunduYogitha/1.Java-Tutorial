...
*/
Example explained
In the example above, time (15) is greater than 10, so the condition is false.
Because of this, we move on to the else condition and print to the screen "Good evening". 
If the time was less than 18, the program would print "Good morning".
...
*/
Example explained
In the example above, time (20) is greater than 10, so the first condition is false. 
